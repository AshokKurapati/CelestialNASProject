getSmbDetails = function(id){ 
   //document.write("<input type=text name=\"company\" />");
    //var gridDom = $("#" + id);

    var popUpContainer = $("#popup-grid_smb");
    ...
    popUpContainer.dialog ({
        ...
        open: function(eve, ui){
            ...
            var grid = $("#smb-details"), ht = grid.parent().height() - 5, wd = grid.parent().width();
            ...
            grid.pqGrid({
                    height: ht,
                    width: wd,
                    colModel: getSmbDetailsColumn(),
                    dataModel: getSmbDataModel(),
