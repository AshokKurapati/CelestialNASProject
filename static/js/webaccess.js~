getWebDetails = function(id){ 
   //document.write("<input type=text name=\"company\" />");
    //var gridDom = $("#" + id);

    var popUpContainer = $("#popup-grid_web");
    ...
    popUpContainer.dialog ({
        ...
        open: function(eve, ui){
            ...
            var grid = $("#web-details"), ht = grid.parent().height() - 5, wd = grid.parent().width();
            ...
            grid.pqGrid({
                    height: ht,
                    width: wd,
                    colModel: getWebDetailsColumn(),
                    dataModel: getWebDataModel(),
