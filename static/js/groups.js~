getGroupDetails = function(id){ 
   //document.write("<input type=text name=\"company\" />");
    ...
    var popUpContainer = $("#popup-grid_group");
    ...
    popUpContainer.dialog ({
        ...
        open: function(eve, ui){
            ...
            var grid = $("#group-details"), ht = $(this).height() - 5, wd = $(this).width() - 30; 
	    grid.parent().css('padding', '2px');
            ...
            grid.pqGrid({
                    height: ht,
                    width: wd,
                    colModel: getGroupDetailsColumn(),
                    dataModel: getGroupDataModel(),
                    render: function(eve, ui){
                        ...
                        $("<span>Add Group</span>").appendTo($toolbar).button({
                            icons: {
			...
			$("<span>Delete Group</span>").appendTo($toolbar).button({
                            icons: {
...
getGroupDetailsColumn = function(){
    return [
        {
            title: "Group Name", width: 100, dataIndx: "name", editable: false
        },
        {
        ...
        {
            title: "Users", width: 100, dataIndx: "user", editable: false
        },
	{
...
selectGroup = function(){
    var popUpContainer = $("#group_select");
    popUpContainer.dialog ({
        autoOpen: false,
        height: 400,
        width: 500,
        ...
        success: function(response){
            ...
            html = [
             ...
             $("#group_select_inner").html(html.join(""));
        },
        error: function(){
...
unselectGroup = function(){
    var popUpContainer = $("#group_unselect");
    popUpContainer.dialog ({
        autoOpen: false,
        height: 400,
        width: 500,
        ...
        success: function(response){
            ...
            html = [
             ...
             $("#group_unselect_inner").html(html.join(""));
        },
        error: function(){
...
deleteGroup = function(){
    var popUpContainer = $("#group_delete");
    popUpContainer.dialog ({
        autoOpen: false,
        height: 400,
        width: 500,
        ...
        success: function(response){
            ...
            html = [
             ...
             $("#group_delete_inner").html(html.join(""));
        },
        error: function(){
...
addGroup = function(){
    var popUpContainer = $("#group_create");
    popUpContainer.dialog ({
        autoOpen: false,
        height: 400,
        width: 500,
        ...
        success: function(response){
            ...
            html = [
             ...
             $("#group_create_inner").html(html.join(""));
        },
        error: function(){
